...
(function () {
  ...
  var FAQ = [
    { topic: "寄送 / 運費", keys: ["寄送", "運費", "運送", "物流", "宅配", "貨運", "到貨", "出貨方式"],
      a: "商品預設以宅配寄送，運費依重量與材積計算，一般小量約 100–200 元；大量或大型訂單可改走貨運或安排門市自取，能再節省運費。實際運費會在正式報價單上明列，出貨後也會提供物流單號方便追蹤。" },
    { topic: "交期", keys: ["交期", "多久", "幾天", "工作天", "幾個工作天", "出貨時間", "趕件", "急件"],
      a: "一般量產交期約 10–15 個工作天（自確認稿件與付訂後起算）；印刷方式較複雜或數量較大時會略長。若有活動檔期需求，可先告知期望到貨日，我們會協助評估急件排程與可行方案。" },
    { topic: "打樣 / 樣品", keys: ["打樣", "樣品", "借測", "看樣", "試做", "單件"],
      a: "打樣約需 3–5 個工作天，可先確認材質、顏色與印刷效果再量產。部分品項提供「樣品價」單件購買或借測服務（需押金與運費）；確認品質後若正式下單，樣品費多可折抵貨款。" },
    { topic: "付款 / 發票", keys: ["付款", "發票", "含稅", "稅", "匯款", "結帳", "三聯", "報帳"],
      a: "正式報價單會同時列出未稅與含稅金額，一律開立三聯式發票，方便貴司報帳與扣抵。首次合作多採「訂金 + 尾款」（常見 5 成訂金、出貨前付清），實際條件會依訂單金額與品項彈性調整。" },
    { topic: "營業時間", keys: ["營業", "上班", "客服時間", "幾點", "假日", "週末"],
      a: "客服營業時間為週一至週五 09:00–18:00，例假日休息。LINE 訊息非即時回覆，小編會在上班時段依序處理；若較急，建議留下聯絡電話與需求，我們會優先回電。" },
    { topic: "印刷方式", keys: ["印刷", "印製", "印logo", "logo", "網版", "雷雕", "雷射", "熱轉", "燙金"],
      a: "常見印刷方式有網版印刷、熱轉印、雷射雕刻與燙金等，會依材質、顏色數與圖樣複雜度建議最合適的做法。多數品項可印企業 LOGO 或簡單圖文；提供向量檔（AI / PDF）效果最佳，我們也可協助簡單排版，版費依方式另計。" },
    { topic: "詢價方式", keys: ["詢價", "第一次", "提供什麼", "怎麼問", "加好友", "要給什麼"],
      a: "歡迎提供三項資訊加速報價：① 產品編號或參考圖、② 規格需求（尺寸 / 顏色 / 印刷）、③ 數量。再留下聯絡人、電話與 email，我們會儘快回覆正式報價；若還沒有明確品項，也可以直接說用途與預算，由專人為您推薦。" },
    { topic: "客製化", keys: ["客製", "訂製", "客自", "客製化", "改尺寸", "改顏色"],
      a: "多數品項可客製尺寸、顏色、材質與印刷內容，也能依主題做整體包裝設計。客製的最小量與費用依品項而定，通常量越大單價越低；提供需求與預期數量後，我們會評估可行性並給出建議方案。" }
  ];
